...
![PortMaster 日志中心](./assets/31eaa0f7-01e7-4a91-9046-deacb0465727.png)
...
![PortMaster 自定义页面](./assets/5a9b7ff4-0785-45b2-8652-1c479a96cfc4.png)

自定义页适合保存长期复用的项目配置：

- 填项目名、服务名、端口、路径、命令
- 每个输入项都带示例
- 保存后即使 `Close All`，项目记录仍然保留
- 适合前端、后端、Docker Compose 和模型服务

### 端口占用提示

![PortMaster 端口占用提示](./assets/a0e16235-1a28-4b5b-af59-a834a1d94408.png)

当预期端口已经被其他服务占用时，PortMaster 会直接提示：
...
![PortMaster Docker 容器页](./assets/b294e1bc-9224-4530-a51d-e0f995dcb1e9.png)
